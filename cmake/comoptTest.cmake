...
file(GLOB_RECURSE INPUT_FILES RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} *.dat *.txt *.t *.csv)
...
add_test(NAME ${PROJECT_NAME}
  COMMAND ${EXECUTABLE_OUTPUT_PATH}/comopt_test.${EXTENSION} -e ${EXECUTABLE} -i ${CMAKE_CURRENT_SOURCE_DIR} -c ${NUMERICAL_DIFFERENCE_EXECUTABLE} -r "${RESULT_FILES}" -t ${NUMERICAL_DIFFERENCE_TOLERANCE}
